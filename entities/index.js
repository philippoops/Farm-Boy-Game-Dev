...
export default (gameWorld) => {
  ...
  return {
    ...
    Mango: Box(
      world,
      "",
      { x: Constants.WINDOW_WIDTH / 1.7, y: Constants.WINDOW_HEIGHT / 6 },
      { width: 40, height: 40 },
      { isStatic: false, image: Images.mango, label: "Mango" }
    ),
    ...
    EnemyWorm: Box(
      world,
      "",
      { x: Constants.WINDOW_WIDTH / 2, y: Constants.WINDOW_HEIGHT / 6 },
      { width: 40, height: 40 },
      { isStatic: false, image: Images.enemyworm, label: "EnemyWorm" }
    ),
